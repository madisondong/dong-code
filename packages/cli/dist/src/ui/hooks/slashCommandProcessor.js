...
import { GitService, Logger, logSlashCommand, SlashCommandEvent, ToolConfirmationOutcome, } from '@dong-code/dong-code-core';
 ...
 */
export const useSlashCommandProcessor = (config, settings, addItem, clearItems, loadHistory, refreshStatic, onDebugMessage, openThemeDialog, openAuthDialog, openEditorDialog, toggleCorgiMode, setQuittingMessages, openPrivacyNotice, toggleVimEnabled, setIsProcessing) => {
