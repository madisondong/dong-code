...
// Mock @dong-code/dong-code-core and its Config class
vi.mock('@dong-code/dong-code-core', async (importOriginal) => {
  const actualCore =
    await importOriginal<typeof import('@dong-code/dong-code-core')>();
...
const { isGitRepository: mockedIsGitRepository } = vi.mocked(
  await import('@dong-code/dong-code-core'),
);
