...
describe('Logger', () => {
    ...
    describe('saveCheckpoint', () => {
        ...
        it.each([
            ...
            const taggedFilePath = path.join(TEST_GEMINI_DIR, `checkpoint-${sanitizedTag}.json`);
    ...
    describe('deleteCheckpoint', () => {
        ...
        let taggedFilePath;
        beforeEach(async () => {
            taggedFilePath = path.join(TEST_GEMINI_DIR, `${CHECKPOINT_FILE_NAME.replace('.json', '')}-${tag}.json`);
