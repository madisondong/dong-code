...
export declare const GEMINI_CONFIG_DIR = ".dong";
export declare const DEFAULT_CONTEXT_FILENAME = "DONG.md";
export declare const MEMORY_SECTION_HEADER = "## Dong Added Memories";
...
export declare class MemoryTool extends BaseTool<SaveMemoryParams, ToolResult> implements ModifiableTool<SaveMemoryParams> {
