...
const USER_GEMINI_DIR = path.join(os.homedir(), '.dong');
// Project-level .gemini directory in the workspace
const WORKSPACE_GEMINI_DIR = path.join(projectRoot, '.dong');

// Telemetry artifacts are stored in a hashed directory under the user's ~/.dong/tmp
